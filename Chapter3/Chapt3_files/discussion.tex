...
\cor{The original implementation of BASiCS for testing changes in mean expression and expression variability was aimed at borrowing information across all cells, all genes and both conditions.
However, this introduced an identifiability issue since the true scale differences in mean expression between the two conditions was unknown.
Instead, BASiCS was implemented to be run on both conditions independently and to perform a post-hoc correction of scale differences in mean expression.
