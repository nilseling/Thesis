...
\newacronym{TDH3}{\textit{TDH3}}{glyceraldehyde-3-phosphate dehydrogenase 3}
\newacronym{TFBS}{TFBS}{transcription factor binding site}
\newacronym{SNV}{SNV}{single nucleotide variant}
\newacronym{PHO5}{\textit{PHO5}}{repressible acid phosphatase}
...
\newacronym[plural=PRCs,firstplural=polycomb repressive complexes (PRCs)]{PRC}{PRC}{polycomb repressive complex}
...
\newacronym{Sir}{\textit{Sir}}{sirtuin}
...
\newacronym{GRCm38}{GRCm38}{Genome Reference Consortium mouse build 28}
\newacronym{tSNE}{tSNE}{t-distributed stochastic neighbour embedding}
\newacronym{EFDR}{EFDR}{expected false discovery rate}
\newacronym{H2-Aa}{\textit{H2-Aa}}{H-2 class II histocompatibility antigen}
\newacronym{Il2ra}{\textit{Il2ra}}{interleukin 2 receptor alpha}
