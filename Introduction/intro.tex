...
Biological noise, \cor{defined as stochasticity in biochemical reactions within individual cells, contributes to form molecular phenotypic variability in cell populations. }
...
Extrinsic noise on the other hand arises due to \cor{fluctuations} in cellular states (e.g.~cell cycle, cell-to-cell signalling and metabolism)  \citep{Zopf2013, Iwamoto2016, Kiviet2014}. 
Recent technological advances allow the in-depth analysis \cor{of molecular phenotypic variability as proxy for} biological noise in cell populations. 
...
With the emergence of \gls{scRNA-Seq} technologies, new computational strategies to quantify \cor{variability} were introduced \cite{Brennecke2013, Vallejos2015BASiCS, Kolodziejczyk2015cell, Buettner2015, Fan2016, Richard2016}. 
Applying high-throughput scRNA-Seq to mammalian systems characterised the functional role of \cor{molecular variability} in healthy as well as diseased contexts. 
Recent studies have described changes in \cor{transcriptional variability} at different stages during embryonic development, which hints at stochastic contributions to early cell fate decisions \citep{Goolam2016, Mohammed2017, Ohnishi2014}. 
...
Furthermore, I outline recent developments of single-cell sequencing and imaging technologies and comment on robust approaches for quantifying \cor{molecular phenotypic variability}. 
Finally, I will summarise Bayesian inference as a powerful statistical framework to model transcriptional \cor{variability} from \gls{scRNA-Seq} data.
\end{Abstract}
